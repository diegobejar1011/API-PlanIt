...
class MySQLRepository {
    getGroupByActivity(activityId) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const result = yield conn_1.db.execute(query, [activityId]);
                return result[0][0];
            }
            catch (error) {
    ...
    getGroupUser(groupUser) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const query = "SELECT id, group_id, user_id FROM group_user WHERE id = ?";
                const result = yield conn_1.db.execute(query, [groupUser]);
                return result[0][0];
            }
            catch (error) {
                throw new Error(error.message);
    ...
    getGroupByToken(token) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const result = yield conn_1.db.execute(query, [token]);
                return result[0][0];
            }
            catch (error) {
                throw new Error(error.message);
    ...
    createGroup(group) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const result = yield conn_1.db.execute(query, [group.user_id, group.name, group.description, group.token]);
                const queryToAddUserToGroup = "INSERT INTO group_user (group_id, user_id) VALUES (?, ?)";
                yield conn_1.db.execute(queryToAddUserToGroup, [result[0].insertId, group.user_id]);
